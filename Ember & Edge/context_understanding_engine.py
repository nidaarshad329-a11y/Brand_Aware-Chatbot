...
class ConversationType(Enum):
    ...
    COOK_MOTIVATION = "cook_motivation"
...
class ContextUnderstandingEngine:
    ...
    def analyze(self, message: str, history: Optional[List] = None, user_profile: Optional[Dict] = None) -> ContextAnalysis:
        ...
        cook_type = self._detect_cook_type(msg_lower)
        ...
        analysis = self._build_analysis(message, emotion, intensity, intent, confidence,
            cook_type, motivation_level, training_context, escalation, churn, competitors)
...
Return ONLY valid JSON, no other text."""
    ...
    def _detect_cook_type(self, msg_lower: str) -> str:
        kws = self._cfg["cook_type_keywords"]
        for cook_type, keywords in kws.items():
    ...
    def _build_analysis(self, message, emotion, intensity, intent, confidence,
                         cook_type, motivation_level, training_context,
