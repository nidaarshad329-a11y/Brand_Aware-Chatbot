...
class COOKProfile:
    ...
    def update_from_turn(self, turn: ConversationTurn):
        ...
        if turn.context_snapshot.get("cook_type"):
            self.cook_type = turn.context_snapshot["cook_type"]
...
class ConversationStateManager:
    ...
    def __init__(self, session_id: str, user_id: Optional[str] = None):
        ...
        self.cook_profile = COOKProfile(user_id=user_id)
    ...
    def add_turn(self, user_message: str, assistant_response: str, context: Dict, tone: Dict):
        ...
        self.cook_profile.update_from_turn(turn)
    ...
    def _update_risks(self, turn: ConversationTurn, context: Dict):
        ...
        if competitors:
            ...
            self.cook_profile.competitor_mentions.extend(competitors)
    ...
    def needs_motivation_boost(self) -> bool:
        if self.motivation_trend in (MotivationTrend.DECLINING, MotivationTrend.STABLE_LOW):
            return True
        if self.cook_profile.motivation_baseline == "low":
            return True
    ...
    def get_context_summary(self) -> Dict:
        ...
        return {
            ...
            "cook_profile": {
                "cook_type": self.cook_profile.cook_type,
                "motivation_baseline": self.cook_profile.motivation_baseline,
                "training_context": self.cook_profile.training_context,
                "product_knowledge": self.cook_profile.product_knowledge,
                "relationship_stage": self.cook_profile.relationship_stage,
                "injury_history": len(self.cook_profile.injury_history) > 0,
                "considering_switch": self.cook_profile.considering_switch,
            },
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            "cook_profile": {
                ...
                "considering_switch": self.cook_profile.considering_switch,
                "competitor_mentions": self.cook_profile.competitor_mentions,
                "churn_risk_score": self.cook_profile.churn_risk_score,
            },
            "training_goals": self.training_goals,
            "active_issues": [
